/*
    ...
    alright this is a huge mess and i moved it away from search.js because hooooly shit
    if youre brave or foolish you can attempt to tidy this place up
    i wouldnt
...
async function gbSearch(info, args) {
    ...
    //Add to parameters
    var base_params = "?page=dapi&s=post&q=index&tags=rating:safe+-spoilers+" + args.join("+");
...
base.searchTargets.searchbooru = {
    names: ["g", "gb"],
...
base.commands.removesearchedtag = {
